    ...
    <x-card title="订单管理">
        ...
        <el-table :data="tableData" style="width: 100%" @row-click="rowClick">
            ...
            <el-table-column fixed="right" label="操作">
                <template #default="scope">
                    ...
                    <el-link type="primary" :href="scope.row.pdfOss" v-if="scope.row.status == 1" @click.stop="downloadFile(scope.row)">
        ...
        <div class="pager">
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                :current-page.sync="currentPage" :page-size="pageSize" layout="prev, pager, next" background :page-count="totalPage" />
        </div>
    </x-card>
</template>
